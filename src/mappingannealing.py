...
if __name__ == "__main__":
    ...
    dictionary = initial_mapping_determine(netlist_path, cost_estimator_path, library_path)
    abc_mapping_annealing_with_initial_determine(netlist_path, cost_estimator_path, library_path, output_path, dictionary)